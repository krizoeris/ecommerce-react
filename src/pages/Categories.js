...
const Categories = (prop) => {
    const products = [
        ...
        { id: 2, name: 'Galaxy Note', category: 'Phones', brand: 'Samsung', price: 3500, image:"https://image-us.samsung.com/SamsungUS/home/mobile/phones/galaxy-note/pdp/sm-n950/midnight-black/Note8-Front-S-Pen-Midnight-Black-1.jpg?$product-details-jpg$" },
        { id: 3, name: 'Google Pixel', category: 'Laptop', brand: 'Google', price: 3500, image:"https://www.gizmochina.com/wp-content/uploads/2018/03/aa.png" },
        { id: 4, name: 'iPad Mini', category: 'Tablet', brand: 'Apple', price: 2000, image:"https://assets.entrepreneur.com/content/3x2/2000/20200116205943-Ent-iPad.jpeg" },
    ]
